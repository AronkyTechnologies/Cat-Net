#This version of Cat-Net has several bugs such as the one that cannot understand what the IP of the machine is running cat-net 
#And consequently in the scan function it does not show anything
#Fix the auto root on Mac / Linux 
...
def macOS_administrator():
    os.system("""osascript -e 'do shell script "sudo python3 "CAT NET V1.2.4 - BETA.py"" " with administrator privileges'""") #fix
...
print("\n")
print("   ╓▄▄▄▄▄▄▄   ┌▄▄▄▄▄▄▄─   ▄▄▄▄▄▄▄▄▄▄▄▄─   ▄▄▄      ╓▄▄─ ▄▄▄▄▄▄▄▄  ▄▄▄▄▄▄▄▄▄▄▄▄─| Created by IsTk0")
print(" j█████████┐ ███████████ j████████████▌  j██████   ║██▌ ████████ j████████████▌| Cat Net Source code:")
print(" j███        ███     ███      ╞██▌       j███▀██,, ║██▌ ███▄,,,,      ╞██▌     | https://github.com/IsTk0/Python-project/tree/main/Cat-Net%20projec")
print(" j███        ███     ███      ╞██▌ ╔▄▄▄▄ j███ ╞██▌ ║██▌ ████████      ╞██▌     | Version: 1.2.4 BETA Version")
print(" j███        ███████████      ╞██▌ ║████ j███ ╞██▌ ║██▌ ███┘''''      ╞██▌     | Apache Licence")
print(" j███▄▄▄▄▄▄  ███▀▀▀▀▀███      ╞██▌       j███   ██████▌ ███▄▄▄▄▄      ╞██▌     | ")
print("  ╙████████┐ ███     ███      ╞██▌       j███   ╙╙╙███▌ ████████      ╞██▌     | Cat-Net ti da il benvenuto ^.^")
print("\n                Se hai bisogno di un aiuto scrivi help oppure controlla la repository di Cat-Net")
...
while True:
    ...
    if comando == "ssh":
        ...
        print("Warning! Il comando che hai scritto non è stato riconosciuto dalla macchina o risulta inesistente, riprova.")
