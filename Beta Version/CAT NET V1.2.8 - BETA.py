...
print(" j███        ███     ███      ╞██▌       j███▀██,, ║██▌ ███▄,,,,      ╞██▌     | \033[33;40mhttps://github.com/AronkyTechnologies/Cat-Net\033[0;37;40m")
print(" j███        ███     ███      ╞██▌ ╔▄▄▄▄ j███ ╞██▌ ║██▌ ████████      ╞██▌     | \033[34;40mVersion: 1.2.8 BETA Version\033[0;37;40m")
...
def ssh_code():
    ...
    password = getpass.getpass("Password macchina: --> ")
...
def ftp_code():
    server = ftplib.FTP()
    ip_address_input = input("IP Macchina-> ")
    port_input = input("Porta Macchina-> ")
    username_machine_input = input("Username macchina: -> ")
    password_machine_input = getpass.getpass("Password macchina ->")
...
while True:
    ...
    if comando == "ssh":
        ...
        print("                        Es: un: cat-net | pw: cat-net22")
