...
print(Fore.WHITE + " j███        ███     ███      ╞██▌ ╔▄▄▄▄ j███ ╞██▌ ║██▌ ████████      ╞██▌     |"+ Fore.BLUE +" Version: 2.1.1 BETA Version")
...
def info_now_code():
    ...
    if sistema_operativo == "win32":
        ...
        temp = (current_temp.MSAcpi_ThermalZoneTeemperature()[0].CurrentTemperature/10.0)-273.15

    if sistema_operativo == "darwin" or sistema_operativo == "linux":
        print(Fore.RED + "--Funzione presto disponibile su OSX e Linux!--")
